    ...
    public void startScan() {
        ...
        if (mCameraPermission != PackageManager.PERMISSION_GRANTED) {
          ...
          /*  Intent intent = new Intent(mMaterialBarcodeScannerBuilder.getActivity(), MaterialBarcodeScannerActivity.class);
            ...
            MaterialBarcodeScannerActivity dialogFragment = new MaterialBarcodeScannerActivity();
            dialogFragment.show(getMaterialBarcodeScannerBuilder().getActivity().getFragmentManager(), "");
        }
    }
